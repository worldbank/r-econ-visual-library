...
# data <- read_dta("https://github.com/mizuhirosuzuki/R_econ_figures/tree/master/Library/Data/HorizontalBarMultipleVars.dta", encoding = "latin1")
data <- read_dta("Data/HorizontalBarMultipleVars.dta", encoding = "latin1")
