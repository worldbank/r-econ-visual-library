---
pagetitle: "Event Study: With difference-in-difference results"
author: ""
date: ""
---
...
```{r EventStudyDinD, fig.path = '../docs/figure/', warning = FALSE}
...
ggplot(fig_data, aes(x = label, y = es_coef)) +
  ...
  # Be careful in setting the ymin and ymax parameters with respect to the critical value when using pointrange 
