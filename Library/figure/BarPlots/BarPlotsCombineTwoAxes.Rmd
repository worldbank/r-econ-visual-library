...
```{r, echo = FALSE}
includeHTML("../../head.html")
includeCSS("../../../docs/site_libs/custom-css.css")
includeCSS("../../../docs/site_libs/bootstrap-3.3.5/css/cerulean.min.css")
includeHTML("../../../docs/header.html")
```


```{r BarPlotsCombineTwoAxes, fig.path = '../../../docs/figure/BarPlots/'}
