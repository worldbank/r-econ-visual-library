...
# Using ifelse (nested in this case) function to make the treatment_group variable that passes a given test
# Here, "Cash" is assigned to the data point if cashtreat is equal to 1 or "In Kind" if equiptreat is equal to 1. "Control" is assigned to every other case
...
# Create a graph ---------------
ggplot(analysis_data, aes(x = realfinalprofit, 
