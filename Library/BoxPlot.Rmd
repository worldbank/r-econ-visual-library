...
```{r BoxPlot, fig.path = 'figure/BoxPlots/'}
...
# data <- read.dta13("https://github.com/mizuhirosuzuki/R_econ_figures/tree/master/Library/Data/BoxPlot.dta")
data <- read.dta13("Data/BoxPlot.dta")
